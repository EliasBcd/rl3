...
- **Mini-projet** (40min) : Tableau de pilotage avec des visualisations
:::
...
**Nouveau défi -- Données étudiants :**
...
3. Calculez la générale des étudiants
...
```{r}
#| eval: false
# Téléchargez les fichiers de ventes mensuelles depuis Moodle
