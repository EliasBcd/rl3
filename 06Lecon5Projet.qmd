---
title: "Séance 5 : Projet personnel intégré"
...
format:
  ...
  revealjs:
    ...
    footer: "Séance 5 - Projet personnel intégré"
...
::: {.incremental}
- **Données personnelles** : vos propres observations, sondages
- **Données publiques** : INSEE, data.gouv.fr, Kaggle
- **Données du cours** : datasets fournis sur Moodle
- **Données de votre domaine** : économie, psychologie, sport, santé
:::
...
# Présentations {background-color="#8B008B"}
...
## Exercice 3 : Préparer sa présentation {.smaller}
...
::: {.fragment}
**Identifiez vos axes d'amélioration pour la suite du cours.**
:::
...
1. **Finalisez votre projet** si besoin
2. **Mettez à jour votre journal** avec tous les détails
3. **Améliorez** un aspect de votre projet suite aux feedbacks
4. **Réfléchissez** : quelles parties de votre code pourraient être mieux organisées ?
:::

::: {.fragment}
**Prochaine séance :** Organisation et modularité - structurer son code comme un professionnel !
:::
