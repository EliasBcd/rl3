...
## Sur papier, sans machine {.smaller}
...
::: {.notes}
10 minutes de dessin individuel, puis correction collective au tableau.
Regardez si les étudiants confondent filter et select, ou oublient que mutate ajoute une colonne sans retirer les autres.
:::
...
::: {.callout-note}
En option, pour pratiquer davantage : la leçon facultative **Exercice_2**
reprend le chargement et le résumé d'un tableau. Voir
