...
Sans cet argument, R affiche un avertissement et le tableau reste groupé, ce qui fausse les opérations suivantes -- une erreur silencieuse de plus.
:::
...
Barnier, *Introduction à R et au tidyverse* : chapitre sur les statistiques descriptives.
