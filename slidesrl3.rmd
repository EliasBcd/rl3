...
- Apprendre à utiliser les principales librairies (aussi appelées paquets) de R
...
Et de télécharger une leçon, le reste se déroule maintenant sur dans votre console
