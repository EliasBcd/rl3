...
## Le code tourne, le résultat est faux {.smaller}
...
::: {.notes}
15 minutes de recherche en binômes, puis correction collective au tableau.
Le mutate n'est pas assigné : le recodage des valeurs extrêmes ne sert à rien, et l'effectif de 2000 masque le na.rm = TRUE qui écarte déjà 5 non-répondants.
:::
...
::: {.callout-note}
En option, pour pratiquer davantage : la leçon facultative **Exercice_5**
reprend nuage de points, boîte à moustaches et diagramme en bâtons. Voir
