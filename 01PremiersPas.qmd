...
- **Une lecture à faire chez vous** entre les séances : le manuel de Julien Barnier, *Introduction à R et au tidyverse*. Le temps en salle sert à pratiquer, pas à écouter.
- **Des exercices interactifs** avec `swirl`, à faire en séance et à terminer chez vous.
:::
...
Pour aujourd'hui : **Manipulations_simples**, **Types**, **Vecteurs**, **Fonctions**, puis **Logique**.
...
::: {.incremental}
1. Terminez les trois leçons swirl et déposez-les sur Moodle.
2. Lisez les chapitres d'introduction du manuel de Barnier (prise en main, vecteurs).
3. Installez le paquet `tidyverse` chez vous : `install.packages("tidyverse")`. 
C'est long, ne le faites pas au début de la séance 2.
:::
