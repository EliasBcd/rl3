...
- Une partie théorique où nous discuterons des notions de programmation (en `R`) et des commandes
...
1. Le manuel de @Barnier (en français), que vous pouvez lire au fur et à mesure pour la séance suivante.
Il est disponible sur Moodle et en ligne.
2. Les exercices développés par l'équipe @swirldev (en anglais) et traduits et adaptés pour le cours, et d'autres élaborés par moi-même. Ils sont disponibles sur ce [dépôt Github](https://github.com/EliasBcd/InitiationR).
Il faut m'envoyer les fichiers finaux de ces exercices pour la validation.
...
Les assistants par IA type ChatGPT, Gemini ou Claude peuvent en général fournir des réponses, mais elles sont parfois fausses et il n'est pas toujours simple de les comprendre.
