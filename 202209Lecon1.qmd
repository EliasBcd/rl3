...
`log` a pour exemple comme valeur par défaut pour `base = exp(1)`, donnant ainsi le logarithme népérien quand on l'utilise naïvement.
...
Voici l'exemple d'une fonction qui reproduirait un peu naïvement `mean` :
...
On a ensuité évalué cette fonction en 6, d'où le résultat.
