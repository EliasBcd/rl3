...
mean(hdv2003$age)
median(hdv2003$age)
quantile(hdv2003$age, prob=0.75) # l'option "prob=" permet de préciser le quantile souhaité
```
...
La base est disponible au format `.csv` à l'adresse suivante [https://raw.githubusercontent.com/EliasBcd/rl3/main/bases/hdv2003.csv](https://raw.githubusercontent.com/EliasBcd/rl3/main/bases/hdv2003.csv)
...
ggplot(hdv2003, aes(x=sport, y=age)) +
