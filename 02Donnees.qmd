...
::: {.notes}
10 minutes de prédiction individuelle, puis correction collective au tableau.
C'est un diagnostic : notez les questions où la classe se trompe massivement.
:::
...
::: {.incremental}
Terminez les leçons swirl **Tableaux_de_donnes** et **Manipuler_les_donnees**.
:::
