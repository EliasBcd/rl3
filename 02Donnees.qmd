...
Faites la leçon **Dataframes**, et déposez le fichier sur Moodle.

## Pour la prochaine séance {.smaller}

::: {.incremental}
1. Terminez les exercices ci-dessus.
2. Terminez la leçon swirl **Dataframes**.
3. Lisez le chapitre de Barnier sur la manipulation de données avec `dplyr`.
:::
